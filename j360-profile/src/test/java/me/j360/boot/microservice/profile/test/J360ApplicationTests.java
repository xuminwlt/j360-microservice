...
package me.j360.boot.microservice.profile.test;

import me.j360.boot.microservice.profile.J360Configuration;
...
@DirtiesContext
public class J360ApplicationTests {
	...
	public void hasHalLinks() throws Exception {
		ResponseEntity<String> entity = new TestRestTemplate().getForEntity(
				"http://localhost:" + this.port + "/profiles/1", String.class);
